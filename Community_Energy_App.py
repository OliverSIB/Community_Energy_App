...
st.write("This web app is designed to interactively display the analysis from the article released by Social Investment Business titled **'Energy efficiency of community buildings across England: A descriptive analysis'**. It displays publicly available data on the energy performance of non-domestic community buildings in England. If you want to see more detailed analysis on this topic please find our article at **https://www.sibgroup.org.uk/news-insights/new-research-highlights-energy-efficiency-problem-for-vital-community-buildings/.**")
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
